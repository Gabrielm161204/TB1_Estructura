...
private:
	...
	// RECURSIVIDAD: muestra los productos en una cuadricula (varias columnas).
	// (num) -- no se lee del cursor del sistema, por eso es confiable.
...
public:
	...
	void registrarProducto() {
		...
		// indice hash: clave = nombre, valor = puntero al producto
	...
	void mostrarProductosRegistrados() {
		...
		// Reubica el cursor debajo de toda la cuadricula para que el menu
		// no se imprima encima de los productos
	}
